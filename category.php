            ...
            <ul class="main-categories">
              <div class="panel-group category-products" id="accordian">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="shop.php?marca=&amp;categoria=1">Remeras</a>
                    </h4>
                  </div>
                  <div id="sportswear">
                    <div class="panel-body">
                      <ul>
                        <li><a href="shop.php?marca=&amp;categoria=9">M. Largas</a></li>
                        <li><a href="shop.php?marca=&amp;categoria=10">M. Cortas</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="shop.php?marca=&amp;categoria=2">Pantalones</a>
                    </h4>
                  </div>
                  <div id="sportswear">
                    <div class="panel-body">
                      <ul>
                        <li><a href="shop.php?marca=&amp;categoria=4">Largos</a></li>
                        <li><a href="shop.php?marca=&amp;categoria=5">Bermudas</a></li>
                        <li><a href="shop.php?marca=&amp;categoria=6">Cortos</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="shop.php?marca=&amp;categoria=3">Calzado</a>
                    </h4>
                  </div>
                  <div id="sportswear">
                    <div class="panel-body">
                      <ul>
                        <li><a href="shop.php?marca=&amp;categoria=7">Zapatillas</a></li>
                        <li><a href="shop.php?marca=&amp;categoria=8">Zapatos</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
